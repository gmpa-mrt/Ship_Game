...
public class HardLvlGame extends GameView {
    ...
    protected void moveElementRemains() {
        for (int i = 0; i < remains1.length; i++) {
            remains1[i].setLayoutY(remains1[i].getLayoutY() + 4);
        }
        for (int i = 0; i < remains2.length; i++) {
            remains2[i].setLayoutY(remains2[i].getLayoutY() + 4);
        }
    }
